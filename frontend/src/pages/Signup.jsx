...
const Signup = () => {
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[var(--bg-base)]">
      ...
      {/* Animated background orbs — different positions from Login */}
      <div className="animate-float-delay absolute top-[-15%] right-[-10%] h-[600px] w-[600px] rounded-full bg-purple-600/20 blur-[140px] pointer-events-none" />
      <div className="animate-float absolute bottom-[-15%] left-[-10%] h-[500px] w-[500px] rounded-full bg-indigo-600/20 blur-[120px] pointer-events-none" />
      <div className="absolute top-[30%] left-[10%] h-[250px] w-[250px] rounded-full bg-pink-500/10 blur-[90px] pointer-events-none" />
